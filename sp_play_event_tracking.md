# ТЗ для события SP Play (pre-launch)
...
| 4. Регистрация | Регистрируется через форму (интеграция StarPets API): email + имя. XP начинается не с нуля. |
...
| 7. Faction Select | Выбирает фракцию: Minecraft / Knight Online / PUBG / StarPets. XP буст за выбор. |
